    ...
    const loadDatabase = async () => {
      try {
        ...
        if (scenariosRes.length > 0 && scenariosRes[0].values.length > 0) {
          ...
          // Set default to 120kph/75mph scenario
  ...
  const calculateLeaderboard = () => {
    ...
    leaderboardTimeoutRef.current = setTimeout(() => {
      try {
        ...
        const scenarioFilter = leaderboardSelectedScenario ? `AND scenario_name = '${leaderboardSelectedScenario.replace(/'/g, "''")}'` : '';
                    ...
                    <div className="bg-slate-50 dark:bg-slate-800 rounded-lg p-3">
                      <div className="relative">
                        ...
                        <div className="flex justify-between items-center mt-2">
                          ...
                          <span className="text-xs text-slate-500 dark:text-slate-400">1200 kW</span>
                        </div>
                      </div>
                    </div>
                  </div>
